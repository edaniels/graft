...
// warnIfServiceManaged checks if the daemon is managed by launchd and prints
...
func warnIfServiceManaged() bool {
	...
	fmt.Fprintln(os.Stderr, "The daemon is managed by launchd. Use 'graft daemon service stop' to stop it,")
