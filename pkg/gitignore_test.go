...
func TestGitignorePatternToMutagen(t *testing.T) {
	for _, tc := range []struct {
		...
		{"**/build/", "**/build/"},
		{"/go/**/bin/", "/go/**/bin/"},
		{"!/client/py/example_proto/__init__.py", "!/client/py/example_proto/__init__.py"},
	} {
...
// The patterns are the "generated protobufs" block of a typical .gitignore:
...
func TestGitignoreTranslationMatchesGitSemantics(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"server/example_server/proto", true, false},
		// Sources re-included by the negations.
		{"server/example_server/proto/internal_api.proto", false, false},
		{"server/example_server/proto/BUILD.bazel", false, false},
		// Generated outputs stay ignored.
		{"server/example_server/proto/internal_api_pb2.py", false, true},
		{"server/example_server/proto/generated", true, true},
		// "*proto" matches neither the "protos" directory nor a "*.proto"
		// leaf file, so nothing under this tree is ignored (matches git).
		{"server/example_server/authzed/protos", true, false},
		{"server/example_server/authzed/protos/BUILD.bazel", false, false},
		{"server/example_server/authzed/protos/authzed/api/v1", true, false},
		{"server/example_server/authzed/protos/authzed/api/v1/core.proto", false, false},
	} {
